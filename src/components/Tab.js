  ...
  return (
    <>
      <div className="bg-[#F2F2F2] py-5 mt-5">
        <div>
          <p className="or-divider my-3">
            <span className="span">VERSATILE AD FORMATS</span>
          </p>
          <div className="wrapper">
            <div className="buttonWrapper flex justify-around my-5 text-center">
              <button
                className="tab-button active w-52 h-10 rounded-2xl shadow"
                data-id="pop-under"
              >
                POP UNDER
              </button>
              <button
                className="tab-button w-52 h-10 rounded-2xl shadow"
                data-id="banner-ad"
              >
                BANNER AD
              </button>
            ...
            <div className="contentWrapper">
              <div className="content active" id="pop-under">
              ...
              <div className="content" id="banner-ad">
                <div className="mt-6 flex justify-between px-5 w-full h-60">
                  <div className="imgSide w-3/4 bg-blue-300">
                    (Image will be changed)
                  </div>
              ...
              <div className="content" id="native">
                <div className="mt-6 flex justify-between px-5 w-full h-60">
                  <div className="imgSide w-3/4 bg-blue-300">
                    (Image will be changed)
                  </div>
